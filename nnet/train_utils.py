...
class Flatten(nn.Module):
    ...
    def forward(self, input):
        # print here may help with figuring out input dimensions of following layers
        # ex: nn.Linear(previous_layer_size*X*Y,current_layer_output_size)
        # where X*Y = dimensions obtained with input.shape
        # print(input.shape)
...
def train_model(train_data, dev_data, model, lr=0.01, momentum=0.9, nesterov=False, n_epochs=10):
    ...
    # TODO modularize and try other options
